...
#pragma warning disable 649 // disable unassigned variable warning
    ...
    private void Initialize(GameObject parent, Vector3Int position)
    {
        if (meshFilter == null)
        {
            ...
            chunkGameObject.transform.position = position - new Vector3Int(TerrainData.width / 2, TerrainData.height / 2, TerrainData.width / 2);
    ...
    private void GenerateMesh(ComputeShader verticesComputeShader, ComputeShader marchCubeComputeShader, Vector3Int offset, int precision)
    {
        ...
        verticesComputeShader.SetInt("chunkWidth", numberOfVertexWidth / precision);
        verticesComputeShader.SetInt("chunkHeight", numberOfVertexHeight / precision);
